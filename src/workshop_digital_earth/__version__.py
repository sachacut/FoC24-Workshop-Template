__title__ = 'workshop_digital_earth'
__description__ = 'A short description of the project'
__url__ = 'https://github.com/augmentedfabricationlab/workshop_digital_earth'
__version__ = '0.1.0'
__author__ = 'Augmented Fabrication Lab'
__author_email__ = 'doerfler@tum.de'
__license__ = 'MIT license'
__copyright__ = 'Copyright 2023 Augmented Fabrication Lab'
